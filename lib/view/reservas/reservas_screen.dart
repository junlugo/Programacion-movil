        ...
        child: Padding(
          ...
          child: Obx(() {
            return Column(
              ...
              children: [
                const Text("Seleccione el horario",
                ...
                const SizedBox(height: 16),
                const Text("Seleccione el lugar disponible",
                    style: TextStyle(fontWeight: FontWeight.bold)),
                const SizedBox(height: 8),
                Obx(() {
                  return Wrap(
                ...
                Obx(() {
                  ...
                  if (auto == null || piso == null || lugar == null || inicio == null || salida == null) {
